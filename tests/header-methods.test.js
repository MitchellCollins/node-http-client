...
describe("custom IncomingMessage header methods", () => {
  ...
  it("should have getHeader method", () => {
    assert.strictEqual(
      typeof customHttp.IncomingMessage.prototype.getHeader,
      "function",
    );
  });
  ...
  it("should have getHeaders method", () => {
    assert.strictEqual(
      typeof customHttp.IncomingMessage.prototype.getHeaders,
      "function",
    );
  });
  ...
  it("should have getHeaderNames method", () => {
    assert.strictEqual(
      typeof customHttp.IncomingMessage.prototype.getHeaderNames,
      "function",
    );
  });
  ...
  it("should have hasHeader method", () => {
    assert.strictEqual(
      typeof customHttp.IncomingMessage.prototype.hasHeader,
      "function",
    );
  });
});
